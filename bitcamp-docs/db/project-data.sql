...
insert into lms_lesson(lesson_id, titl, conts, sdt, edt ,tot_hr, day_hr)
values (102,'C/C++ 프로그래밍', 'C/C++ 프로그래밍 배우기', '2019-2-2', '2019-3-28', 200, 6);
insert into lms_lesson(lesson_id, titl, conts, sdt, edt ,tot_hr, day_hr)
values (103,'파이썬 프로그래밍', '파이썬 프로그래밍 배우기', '2019-3-3', '2019-4-28', 300, 6);
insert into lms_lesson(lesson_id, titl, conts, sdt, edt ,tot_hr, day_hr)
values (104,'웹 프로그래밍', '웹 프로그래밍 배우기', '2019-4-4', '2019-5-28', 400, 6);
insert into lms_lesson(lesson_id, titl, conts, sdt, edt ,tot_hr, day_hr)
values (105,'Iot 프로그래밍', 'Iot 프로그래밍 배우기', '2019-5-5', '2019-6-28', 500, 6);
...
values (1, 101, '자바 컴파일러 구동원리');
insert into lms_photo(photo_id, lesson_id, titl)
values (2, 101, '자바 클래스 실행하는 방법');
insert into lms_photo(photo_id, lesson_id, titl)
values (3, 101, '자바 클래스 실행하는 방법');
insert into lms_photo(photo_id, lesson_id, titl)
values (4, 104, 'HTML/CSS/JS관계');
insert into lms_photo(photo_id, lesson_id, titl)
values (5, 104, '자바 스크립트 구동원리');
