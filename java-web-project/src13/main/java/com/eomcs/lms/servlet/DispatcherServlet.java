...
public class DispatcherServlet extends HttpServlet {
  ...
  private Object getObjectValue(
    ...
    try {
      ...
      // 예) ==> obj.setTitle(request.getParameter("title"));
      ...
      // 요청 핸들러가 원하는 객체를 준비하다가 예외가 발생하면 return null
      return null;
    }
  } // getObjectValue
