...
<body>
  ...
  <div class="container">
    ...
    <form action="search" class="form-inline my-2 my-lg-0">
        <input type="number" class="form-control mr-sm-2" name="lessonNo" placeholder="수업번호" aria-label="검색">
        <input class="form-control mr-sm-2" name="keyword" placeholder="검색어" aria-label="검색">
      ...
      <ul class="pagination justify-content-center">
        ...
        <c:forEach begin="${pageNo-1 }" end="${pageNo+1}" step="1" var="page">
          <li
            class="page-item ${page == pageNo ? 'active' : '' } ${(page < 1) || (page > totalPage) ? 'disabled' : ''}">
