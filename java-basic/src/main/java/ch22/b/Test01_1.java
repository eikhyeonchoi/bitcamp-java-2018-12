...
public class Test01_1 {
  public static void main(String[] args) {
    ...
    // ==> 메모장으로 편집이 불가능한 파일
    // ==> 보통 전용 프로그램을 이용해 편집하는 파일
    // ==> 예) .hwp  .gif  .mp3  .mp4  .jpeg  .ppt  .xls  .doc  .class  ...
    
    // 텍스트 데이터?
    // ==> 특정 character set(문자표) 규칙에 따라 작성한 파일
    // ==> 메모장으로 편집이 가능한 파일
    // ==> 예) .txt  .c  .cpp  .java  .xml  .html  .css  .js  .py
    //          .docx  .xlsx  .pptx ...
    ...
    // 1) 데이터 출력을 담당할 객체를 생성
    try (FileOutputStream out = new FileOutputStream("data.bin");){
      // 2) 데이터를 출력한다
      // ==> write(int) 파라미터 타입이 int라 해서 4바이트를 출력하는 것이 아님
      //       오직 1바이트만 출력한다
      out.write(2);
      out.write(40);
      out.write(100);
      ...
      out.write(0x55667788); // 맨 끝 1바이트만 출력
