...
// 제네릭 o
// 클래스 전체에서 사용할 타입 파라미터 선언
// ==> class 클래스명<타입파라미터, 타입파라미터명, 타입파라미터명...>
...
class Box2<T> {
  ...
  public T getValue() { // T라는 타입의 객체를 return
    return this.value;
  }
}
...
public class Test04 {
  public static void main(String[] args) {
    ...
    Date y4 = x4.getValue(); // 형변환 필요 x
                                 // 마치 Date를 return하는 getValue() 메서드가 있는 것같다
    // 제네릭은 다형성의 유연함을 그대로 유지하면서 특정 타입의 데이터를 다루도록 도와주는
    // 매우 편리한 문법이다
