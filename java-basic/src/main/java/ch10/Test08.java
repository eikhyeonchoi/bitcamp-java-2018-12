...
class Monitor6{
  ...
  //    
  // 생성자의 호출 절차
  // ==> 인스턴스 생성 ==> 인스턴스 필드 초기화 문장 실행 ==> 인스턴스 블럭 실행 ==> 생성자 실행
  // 
  // 생성자 호출하는 방법
...
public class Test08 {
  public static void main(String[] args) {
    ...
    // ==> 지정하지 않으면 compile error
    // new Monitor6; compile error
    
    // 2) 파라미터가 없는 생성자를 호출할 경우 값 없이 지정한다
    new Monitor6();
    
    // 3) 파라미터 값을 받지 않는 생성자를 호출할 때 값을 주면 compile error
    // new Monitor6(100); compile error
