...
public class Test01 {
  public static void main(String[] args) {
    ...
    // 맵에 값 저장하기
    // ==> key객체에 대해 hashCode()를 호출해 정수 값을 얻는다anObject
    ...
    // 2) hashCode()의 return값을 가지고 데이터 찾을 위치를 결정한다
    ...
    //    equals()의 리턴 값이 true 이므로 두 인스턴스는 같은 key로 간주 한다
