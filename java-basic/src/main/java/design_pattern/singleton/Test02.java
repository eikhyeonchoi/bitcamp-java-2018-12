...
class Car2 {
  ...
  public static Car2 getInstance() {
    if(Car2.instance == null) {
      // 아직 인스턴스를 생성한 적이 없다면 즉시 인스턴스 생성
      Car2.instance = new Car2();
    }
    // 기존에 변수에 저장된 인스턴스 주소를 return
...
public class Test02 {
  public static void main(String[] args) {
    ...
    // 생성자가 존재하지만 private로 비공개 되어있기 때문에 직접 호출할 수 없다
    // 생성자를 호출할 수 없으면 인스턴스를 생성할 수 없다
    // 다른 메서드를 호출하여 인스턴스를 생성하라는 의미
    // Car2 c1 = new Car2();
    ...
    if (c2 ==c3) System.out.println("같다");
