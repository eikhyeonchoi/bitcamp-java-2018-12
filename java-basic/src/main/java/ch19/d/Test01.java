...
public class Test01 {
  public static void main(String[] args) {
    ...
    //     그 하위 필드도 마찬가지로 dot(.)을 이용하여 지정할 수 있다
    //     이런 식으로 dot(.)을 이용하여 하위 필드를 지정하는 표기법을 OGNL이라 한다
    // ==> static nested class를 사용하여 더 극단적으로 분류 값을 OGNL 표기법으로 사용할 수 잇음
    // ==> 다음과 같이 하나의 이름을 사용하는 대신 dot(.)을 사용하여 하위 프로퍼티를 접근하는 방식은
