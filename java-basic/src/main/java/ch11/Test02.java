// String 클래스 사용법 2 - 문자열 리터럴로 String instance생성하기
package ch11;

public class Test02 {
  public static void main(String[] args) {
    
    String s1 = "hello"; // ==> 스트링 상수풀에 생성
    ...
    String s2 = "hello"; 
    // 이미 같은 문자열을 가진 인스턴스가 있기 때문에 기존 인스턴스 주소 return
    // 메모리를 절약하기 위해서임
    ...
    // instanceof 연산자
    // ==> 레퍼런스가 가리키는 인스턴스가 특정 클래스의 인스턴스인지 확인하는 연산자
