...
// ApplicationListener 규첵에 따라 클래스를 작성해야 한다
public class MemberDataLoaderListener implements ApplicationListener {
  ...
  public void startApplication(Map<String, Object> context) {
    System.out.println("Application이 시작 될 때 준비 작업을 수행한다.");
    try (ObjectInputStream in =
      ...
      System.out.println("멤버 데이터를 읽는 중 오류 발생: " + e.toString());
  ...
  public void endApplication(Map<String, Object> context) {
    System.out.println("Application이 종료 될 때 마무리 작업을 수행한다.");
