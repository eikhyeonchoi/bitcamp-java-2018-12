...
public class App {
  ...
  // Application의 상태 변경을 보고 받을 옵저버 목록
  ...
  public static void main(String[] args) {
    // 애플리케이션의 상태가 변경되었을 때 보고 받을 리스너를 등록한다
    ...
    // 애플리케이션이 시작될 때 등록된 리스너에게 보고한다
    // 반복문 도는 이유가 
    // BoardDataLoaderListener
    // MemberDataLoaderListener
    // LessonDataLoaderListener
    // 이 3개의 Observer(Listener)에게 알리기 위함이다
    ...
    // 애플리케이션이 종료될 때 다시 등록된 리스너를 꺼내  보고한다
    // 반복문 도는 이유가 
    // BoardDataLoaderListener
    // MemberDataLoaderListener
    // LessonDataLoaderListener
