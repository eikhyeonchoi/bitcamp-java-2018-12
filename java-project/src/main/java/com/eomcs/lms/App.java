...
public class App {
  ...
  public static void addListener(ApplicationContextListener listener) {
    observers.add(listener);
  }

  @SuppressWarnings("unchecked")
  public static void main(String[] args) {
    addListener(new BoardDataLoaderListener());
    addListener(new MemberDataLoaderListener());
    addListener(new LessonDataLoaderListener());
